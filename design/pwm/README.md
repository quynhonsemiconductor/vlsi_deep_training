...
| File | What it is |
|---|---|
| `rtl/emacs/m_qnsc_wrap_apb_adv_timer.src.sv` | the source to edit: port groups, added logic, `AUTO_TEMPLATE` |
| `rtl/m_qnsc_wrap_apb_adv_timer.sv` | generated by `make wrap BLOCK=pwm`, compiled through `pwm.f`; never edited by hand |
